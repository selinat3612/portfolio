...
import gw23 from './imgs/greekweek2023.png';
...
<div>
  ...
  <div className="internship-container">
      <div className="art">
          <div>
              <h2 style={{marginTop: '10%'}}>WPI Greek Week</h2>
              <h3 style={{fontWeight: 'lighter'}}>Logo design for Greek Week 2023</h3>
              <h3 style={{fontWeight: 'lighter', marginTop: '8%'}}>Designed in Illustrator</h3>
              <div className="detail-item" style={{marginTop: '15%'}}>
                  <h2>Inspired by Greek Week theme "Greek Life is Going to Space" to illustrate an astronaut on the horizon bearing the WPI flag</h2>
              </div>
          </div>
      <div>
          <img src={gw23} onClick={handleImageClick} className="gw" alt="logo"></img>
      </div>
      {isModalOpen && (
        <div className="modal-overlay" onClick={closeModal} style={modalOverlayStyles}>
          <div className="modal-content" style={modalContentStyles}>
            <img src={gw23} style={{ width: '100%', height: '100%' }} alt="logo" />
          </div>
        </div>
      )}
      </div>
